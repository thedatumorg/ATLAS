/*blk_file.h:
  this file specifies the class BlockFile2, a block file simulator
  Modified by Yifang
*/
#ifndef __BLK_FILE
#define __BLK_FILE
...
class BlockFile2{
 public:
  ...
  bool new_flag;	 // specifies if this is a new file
   ...
   //=====================================================
  BlockFile2(char* name, int b_length);// filename and block length
...
//-------------------------------------------------------------------------
class CachedBlockFile : public BlockFile2{
 public:
